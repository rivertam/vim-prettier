...
test('Prettier formats javascript file', async () => {
  await remote.edit(
    '/home/miter/repo/mitermayer/vim-prettier/tests/fixtures/javascript/foo.js',
  );
...
test('Prettier formats javascript file Async', async () => {
  await remote.edit(
    '/home/miter/repo/mitermayer/vim-prettier/tests/fixtures/javascript/foo.js',
  );
